...
class CaptureAppTest {
	...
	CaptureWorld w1 = new CaptureWorld(p1, f1);
	CaptureWorld w2 = new CaptureWorld(p2, f1);
	...
	void KeyPressed() {
		...
		assertEquals(new CaptureWorld(new Player(new Posn (50, 60), p1.score), w1.flag), 
				w1.keyPressed(new KeyEvent(null, 0, 0, 0, '\0', PApplet.DOWN)));
		assertEquals(new CaptureWorld(new Player(new Posn (60, 50), p1.score), w1.flag), 
